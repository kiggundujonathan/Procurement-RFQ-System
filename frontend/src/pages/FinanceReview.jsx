...
useEffect(() => {
  const loadFinanceQueue = async () => {
    try {
      ...
      console.log("Finance Queue:", response.data);
...
console.log("FILTERED:", financeRequests);
const filteredRequests = financeRequests.filter(
  (req) =>
    (req.requestId || "")
      .toLowerCase()
  ...
  <div>
    ...
    >
      Review procurement requests awaiting budget approval.
    </p>
